...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            body { background: url({{asset('public/admin_assets/img/bg-login.jpg')}}) !important; }
        </style>
        <script>
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="{{URL::to('/dashboard')}}"><span>Dashboard</span></a>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li>
                                <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Category Management </span><span class="label label-important"></span></a>
                                <ul>
                            ...
                            <li>
                                <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Author Management </span><span class="label label-important"></span></a>
                                <ul>
                                    <li><a class="submenu" href="{{URL::to('/add-author')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Author </span></a></li>
                                    <li><a class="submenu" href="{{URL::to('/manage-author')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Author </span></a></li>
                                </ul>	
                            </li>
                            <li>
                                <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Post Management </span><span class="label label-important"></span></a>
                                <ul>
                                    <li><a class="submenu" href="{{URL::to('/add-post')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Post </span></a></li>
                                    <li><a class="submenu" href="{{URL::to('/manage-post')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Post </span></a></li>
                                </ul>	
                            </li>
